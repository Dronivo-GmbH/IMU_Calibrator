...
FACE_GUIDES = [
    ...
    },
    {
        ...
        "step": 3,
        "short": "+X",
        "title": "Position 3 — On RIGHT edge (+X pointing up)",
        "pose": "edge_x_up",
        "up_axis": np.array([1.0, 0.0, 0.0]),
        "steps": [
            "Stand the board on its RIGHT edge (see diagram).",
            "Only one narrow edge touches the table.",
            "The +X axis (red arrow on diagram) points straight UP.",
            "Use a book or box to stop it falling if needed.",
        ],
        "hint": "When correct, X reads the largest positive value.",
    },
    {
        "name": "-X up",
        "step": 4,
        "short": "-X",
        "title": "Position 4 — On LEFT edge (-X pointing up)",
        "pose": "edge_x_down",
        "up_axis": np.array([-1.0, 0.0, 0.0]),
        "steps": [
            "Stand the board on its LEFT edge — mirror of Position 3.",
            "The -X axis points straight UP toward the ceiling.",
            "Hold steady — do not start capture until stable.",
            "When correct, X reads the largest negative value.",
        ],
        "hint": "Opposite edge from Position 3.",
    },
    {
        "name": "+Y up",
        "step": 5,
        "short": "+Y",
        "title": "Position 5 — On FRONT edge (+Y pointing up)",
        "pose": "edge_y_up",
        "up_axis": np.array([0.0, 1.0, 0.0]),
        "steps": [
            "Stand the board on its FRONT edge (short edge toward you).",
            "The +Y axis (green arrow) points straight UP.",
            "Support the board so it cannot slip.",
            "When correct, Y reads the largest positive value.",
        ],
        "hint": "Think of the board as a book standing on its front cover edge.",
    },
    {
        "name": "-Y up",
        "step": 6,
        "short": "-Y",
        "title": "Position 6 — On BACK edge (-Y pointing up)",
        "pose": "edge_y_down",
        "up_axis": np.array([0.0, -1.0, 0.0]),
        "steps": [
            "Stand the board on its BACK edge — opposite of Position 5.",
            "The -Y axis points straight UP.",
            "This is the final position.",
            "When correct, Y reads the largest negative value.",
        ],
        "hint": "After capture, click Finish calibration.",
    },
]
